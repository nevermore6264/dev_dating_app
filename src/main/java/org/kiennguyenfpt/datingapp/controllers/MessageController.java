...
public class MessageController {
    ...
    public ResponseEntity<CommonResponse<Message>> sendMessage(@RequestBody MessageRequest messageRequest) {
        ...
        try {
            Message message = messageService.sendMessage(messageRequest.getMatchId(), messageRequest.getSenderId(), messageRequest.getReceiverId(), messageRequest.getContent());
    ...
    public ResponseEntity<CommonResponse<List<Message>>> getMessages(@PathVariable Long matchId) {
